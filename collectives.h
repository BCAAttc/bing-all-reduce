...
void RingAllreduce_1(float* data, size_t length, float** output);

void RingAllreduce_n(float* data, size_t length, float** output);
...
void RingAllgather_1(float* data, size_t length, float** output);
